...
-- Demo users advertised by the application login screen.
-- Passwords are demo credentials and are intentionally reset when this seed is re-run.
INSERT INTO users (username, email, password_hash, role, is_active) VALUES
    ('admin', 'admin@edupulse.edu',
     crypt('admin123', gen_salt('bf')), 'admin', TRUE),
    ('lecturer', 'lecturer@edupulse.edu',
     crypt('lecturer123', gen_salt('bf')), 'lecturer', TRUE),
    ('student', 'student@edupulse.edu',
     crypt('student123', gen_salt('bf')), 'student', TRUE)
...
SELECT
    ...
    'Dr.'
FROM users WHERE username = 'lecturer'
